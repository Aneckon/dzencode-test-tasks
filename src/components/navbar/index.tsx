...
export const Navbar = () => {
  ...
  return (
    <nav className={styles.navbar}>
      ...
      <ul>
        <li>
          <Link className={pathname === '/' ? styles.link__active : ''} href={'/'}>
            ПРИХОД
          </Link>
        </li>
        <li>
          <Link className={pathname === '/groups' ? styles.link__active : ''} href={'/groups'}>
            ГРУППИ
          </Link>
        </li>
        <li>
          <Link className={pathname === '/products' ? styles.link__active : ''} href={'/products'}>
            ПРОДУКТИ
          </Link>
        </li>
        <li>
          <Link className={pathname === '/users' ? styles.link__active : ''} href={'/users'}>
            ПОЛЬЗОВАТЕЛИ
          </Link>
        </li>
        <li>
          <Link className={pathname === '/settings' ? styles.link__active : ''} href={'/settings'}>
            НАСТРОЙКИ
          </Link>
        </li>
      </ul>
